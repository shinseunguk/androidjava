...
public class DBConnectionMgr {
	//Vector?? arrayList Í∞ôÏ? Í∞úÎÖê?ù¥?ã§.¬†
    private Vector connections = new Vector(10);//Ïª§ÎÑ•?Öò?ùÑ ?ã§ ?Ñ£?ñ¥?ëêÍ≥? ?Ç¨?ö©?ïò?äî Í∞úÎÖê?ù¥?ã§.
    private String _driver = "com.mysql.jdbc.Driver",
    _url = "jdbc:mysql://127.0.0.1:3366/virus?useUnicode=true&characterEncoding=utf8",
    _user = "root",
    _password = "1234";

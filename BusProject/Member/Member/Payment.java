...
public class Payment {
	...
	public static void main(String[] args) {
		...
		JLabel l1 = new JLabel("Ä«µå °áÁ¦");
		l1.setHorizontalAlignment(SwingConstants.CENTER);
		l1.setFont(new Font("±¼¸²", Font.BOLD, 20));
		l1.setBounds(328, 10, 116, 49);
		f.getContentPane().add(l1);
		
		JRadioButton rdbtnNewRadioButton = new JRadioButton("°³ÀÎ");
		...
		JRadioButton rdbtnNewRadioButton_1 = new JRadioButton("¹ýÀÎ");
		...
		JLabel l1_2 = new JLabel("Ä«µå ¹øÈ£");
		...
		JLabel l1_2_1 = new JLabel("À¯È¿ ±â°£ ¿ù(MONTH)");
		...
		JLabel l1_2_1_1 = new JLabel("À¯È¿ ±â°£ ³â(YEAR)");
		...
		JLabel l1_2_1_2 = new JLabel("Ä«µå ºñ¹Ð¹øÈ£");
		...
		JLabel l1_2_1_1_1 = new JLabel("»ý³â¿ùÀÏ(YYYYMMDD)");
		...
		JLabel l1_3 = new JLabel("ÃÑ °áÁ¦±Ý¾×");
		...
		String card[]= {"·Ôµ¥","ÇÏ³ª","±¹¹Î","BC","½ÅÇÑ","»ï¼º","³óÇù","Çö´ë","ÀüºÏ","¼öÇù","¿ì¸®","±¤ÁÖ","¾¾Æ¼"};
